...
async def pull_profile(ens_id: str, latest_session_id: str, session):
    ...
    copr_required_cols = ["employee", "name", "location", "address", 'website', 'e_filing_status', 'category',
...
async def pull_kpis(ens_id: str, session_id: str, session):
        ...
        kpi_table_name = ['legal', 'adverse_media','entity_existence', 'finance', 'cyber_esg']
